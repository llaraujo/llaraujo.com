 ...
 */
window.Modernizr=(function(A,c,g){var J="2.6.3pre",w={},y=true,M=c.documentElement,a="modernizr",I=c.createElement(a),E=I.style,L=c.createElement("input"),C=":)",b={}.toString,j=" -webkit- -moz- -o- -ms- ".split(" "),h="Webkit Moz O ms",F=h.split(" "),K=h.toLowerCase().split(" "),H={svg:"http://www.w3.org/2000/svg"},l={},p={},f={},e=[],k=e.slice,s,n=function(V,X,P,W){var O,U,R,S,N=c.createElement("div"),T=c.body,Q=T||c.createElement("body");
...
if(P!==g){if(Q===false){return O[N];}if(r(P,"function")&&"bind" in P){return P.bind(Q||R);}return P;}}return false;}function m(R,N,Q){var O=R.charAt(0).toUpperCase()+R.slice(1),P=(R+" "+F.join(O+" ")+O).split(" ");
...
if(w[O]!==g){return w;}P=typeof P=="function"?P():P;if(typeof y!=="undefined"&&y){M.className+=" "+(P?"":"no-")+O;}w[O]=P;}return w;};D("");I=L=null;
...
var ac;var U="_html5shiv";var N=0;var aa={};var R;(function(){try{var af=Y.createElement("a");af.innerHTML="<xyz></xyz>";ac=("hidden" in af);R=af.childNodes.length==1||(function(){(Y.createElement)("a");
var ah=Y.createDocumentFragment();return(typeof ah.cloneNode=="undefined"||typeof ah.createDocumentFragment=="undefined"||typeof ah.createElement=="undefined");
}());}catch(ag){ac=true;R=true;}}());function S(af,ah){var ai=af.createElement("p"),ag=af.getElementsByTagName("head")[0]||af.documentElement;ai.innerHTML="x<style>"+ah+"</style>";
return ag.insertBefore(ai.lastChild,ag.firstChild);}function X(){var af=V.elements;return typeof af=="string"?af.split(" "):af;}function ab(af){var ag=aa[af[U]];
if(!ag){ag={};N++;af[U]=N;aa[N]=ag;}return ag;}function Z(ai,af,ah){if(!af){af=Y;}if(R){return af.createElement(ai);}if(!ah){ah=ab(af);}var ag;if(ah.cache[ai]){ag=ah.cache[ai].cloneNode();
}else{if(O.test(ai)){ag=(ah.cache[ai]=ah.createElem(ai)).cloneNode();}else{ag=ah.createElem(ai);}}return ag.canHaveChildren&&!T.test(ai)?ah.frag.appendChild(ag):ag;
}function ad(ah,aj){if(!ah){ah=Y;}if(R){return ah.createDocumentFragment();}aj=aj||ab(ah);var ak=aj.frag.cloneNode(),ai=0,ag=X(),af=ag.length;for(;ai<af;
ai++){ak.createElement(ag[ai]);}return ak;}function ae(af,ag){if(!ag.cache){ag.cache={};ag.createElem=af.createElement;ag.createFrag=af.createDocumentFragment;
ag.frag=ag.createFrag();}af.createElement=function(ah){if(!V.shivMethods){return ag.createElem(ah);}return Z(ah,af,ag);};af.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+X().join().replace(/\w+/g,function(ah){ag.createElem(ah);
ag.frag.createElement(ah);return'c("'+ah+'")';})+");return n}")(V,ag.frag);}function P(af){if(!af){af=Y;}var ag=ab(af);if(V.shivCSS&&!ac&&!ag.hasCSS){ag.hasCSS=!!S(af,"article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}mark{background:#FF0;color:#000}");
...
W.html5=V;P(Y);}(this,c));w._version=J;w._prefixes=j;w._domPrefixes=K;w._cssomPrefixes=F;w.mq=G;w.hasEvent=o;w.testProp=function(N){return z([N]);};w.testAllProps=m;
